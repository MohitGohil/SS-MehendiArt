...
// import post from "./img/post.avif";
import "./App.css";
// import "./style.js";
    ...
    <div className="App">
        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <div className="flex items-center justify-center font-mono">
              ...
              <h1 className="text-2xl ml-1">#shivismehendiart</h1>
            </div>
            <button
              className="text-black border-2 hover:bg-gray-400 hover:text-white bg-gray-300 cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-transparent rounded bg-transparent block lg:hidden outline-none focus:outline-none"
              type="button"
          ...
          <div
            className={
              "lg:flex flex-grow items-center justify-center text-2xl mt-3" +
      ...
      <section>
        <div className="text-gray-700 my-10">
          <h2 className="text-4xl text-center">Mehendi</h2>
        </div>
      ...
      <section className="overflow-hidden text-gray-700 mt-0">
